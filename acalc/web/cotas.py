...
class EsferasPage:
	...
	def result(self, **kwargs):
		...
		try:
			...
			self._values 	= self._values+"<strong>Tipo do dentado:</strong> {}  {} [n]".format(self._tipo1, self._tipo2)
			self._values 	= self._values+"<strong>Ângulo de Pressão:</strong> {} [n]".format(self._alfa)
			if self._beta != "0":
				self._values 	= self._values+"<strong>Ângulo da Hélice:</strong> {}[n]".format(self._beta)
			self._values 	= self._values+"<strong>Módulo:</strong> {} mm [n]<strong>N. de dentes:</strong> {} ".format(self._m, self._zo)
			self._values 	= self._values+"[n]<strong>Largura do dentado:</strong> {}".format(self._l)
			...
			self._carreto = None		
			cherrypy.log(msg=self._message, context='', severity=logging.ERROR, traceback=True)
...
class EkEngrPage:
	...
	def result(self, **kwargs):
		...
		try:
			...
			self._values 	= "<strong>Artigo:</strong> {} [n] [n]".format(self._artigo)
			self._values 	= self._values+"<strong>Tipo do dentado:</strong> {} [n]<strong>Ângulo de Pressão:</strong> {} [n]".format(self._tipo1, self._alfa)
			if self._beta != "0":
				self._values 	= self._values+"<strong>Ângulo da Hélice:</strong> {}[n]".format(self._beta)
			self._values 	= self._values+"[n]<strong>Módulo:</strong> {} mm [n]<strong>Largura do dentado:</strong> {} [n]<strong>Diâmetro Primitivo:</strong> {} ".format(self._m, self._l, self._dp)
			self._values 	= self._values+"[n]<strong>N. Dentes:</strong> {}".format(self._z1)
...
class EkConjPage:
	...
	def result(self, **kwargs):
		...
		try:
			...
			self._values 	= "<strong>Artigo:</strong> {} [n] [n]".format(self._artigo)
			self._values 	= self._values+"<strong>Tipo do dentado:</strong> {} [n]<strong>Ângulo de Pressão:</strong> {}".format(self._tipo1, self._alfa)
			if self._beta != "0":
				self._values 	= self._values+"[n]<strong>Ângulo da Hélice:</strong> {}".format(self._beta)
			self._values 	= self._values+"[n]<strong>Módulo:</strong> {} mm [n]<strong>Largura do dentado:</strong> {} [n]<strong>Entre-eixo de funcionamento:</strong> {} ".format(self._m, self._l, self._eef)
			self._values 	= self._values+"[n]<strong>N. Dentes CARRETO:</strong> {} [n]<strong>N. Dentes RODA:</strong> {}".format(self._z1, self._z2)
...
class EkSemfimPage:
	...
	def result(self, **kwargs):
		...
		try:
			...
			self._values 	= "<strong>Artigo:</strong> {} [n] [n]".format(self._artigo)
			self._values 	= self._values+"<strong>Sentido da Hélice:</strong> {} [n]".format(self._sentido)
			self._values 	= self._values+"<strong>Ângulo de Pressão:</strong> {} [n]".format(self._alfa)
			self._values 	= self._values+"<strong>Ângulo da Hélice:</strong> {}  [n]".format(self._beta)
			self._values 	= self._values+"<strong>Módulo Axial:</strong> {} mm [n]".format(self._m)
			self._values 	= self._values+"<strong>N. entradas do SEM-FIM:</strong> {} [n]".format(self._z1)
			self._values 	= self._values+"<strong>N. dentes do RODA:</strong> {} ".format(self._z2)
