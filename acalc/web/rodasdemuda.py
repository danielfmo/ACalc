...
from acalc.tools.rodasdemuda import Rollete, Reishauer, ReishauerDressage, Pfauter251, Pfauter630, Pfauter2300, Modul, Lindner, Heckert, Spiromatic
...
class P251Page():
    ...
    def result(self, **kwargs):
        ...
        if self._b != None and self._m != None and self._modo != None:
            self.p251 = Pfauter251(
                modulo=self._m, beta=self._b, modo=self._modo, entradas=self._entradas)
