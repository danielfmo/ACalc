...
class Pfauter251 (object):
    def __init__ (self, **kwargs) :
        ...
        if self._modo == 'DIFERENCIAL':
            ...
            self._razao =3/(2*self._m/cos(self._beta)*self._zO)         # modulo, beta, entradas, angulo a 0 para navalhão
        else :
            self._razao = None
...
class Pfauter630 (object):
    def __init__ (self, **kwargs) :
        ...
        if self._modo == 'DIFERENCIAL':
            ...
            self._razao = 3/(self._m/cos(self._beta)*self._zO)          # modulo, beta, entradas, angulo a 0 para navalhão
        else :
            self._razao = None
...
class Pfauter2300 (object):
    def __init__ (self, **kwargs) :
        ...
        if self._modo == 'DIFERENCIAL':
            ...
            self._razao = 8/(3*self._m/cos(self._beta)*self._zO)          # modulo, beta, entradas, angulo a 0 para navalhão
        else :
            self._razao = None
...
class Modul (object):
    def __init__ (self, **kwargs) :
        ...
        if self._modo == 'DIFERENCIAL':
            ...
            self._razao = 3/(self._m/cos(self._beta)*self._zO)    # modulo, entradas
        else :
            self._razao = None
...
class Heckert (object):
    def __init__ (self, **kwargs) :
        self._name       = 'Heckert'
        self._modelo     = 'Heckert ZFWVG 250'
